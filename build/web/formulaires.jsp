            ...
            <div class="row">
                <div class="col">
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/servletClient" method="POST" >
                        <fieldset>                            
                            <legend class="text-center"> Créer client</legend>
        
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="bank_id">Nom</label>  
                                <div class="col">
                                    <input name="nomClient" type="text" placeholder="Nom" class="form-control input-md" required>                                <span class="help-block">Le nom du client</span>  
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="numClient">Numéro</label>  
                                <div class="col">
                ...
                <div class="col">                
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/servletAccount" method="POST">
                        <fieldset>                            
                            <legend class="text-center">Ajout Account</legend>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="textinput">Libelle</label>  
                                <div class="col">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="textinput"><span class="fas fa-money-bill-alt"></span> Oseille</label>  
                                <div class="col">
